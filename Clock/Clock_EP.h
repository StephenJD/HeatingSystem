...
private:
	...
	auto writer(uint16_t& address, const void* data, unsigned int noOfBytes)->I2C_Talk_ErrorCodes::Error_codes;
	auto reader(uint16_t& address, void* result, unsigned int noOfBytes)->I2C_Talk_ErrorCodes::Error_codes;
