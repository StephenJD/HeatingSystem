...
public:
	...
	uint8_t write(uint16_t deviceAddr, uint8_t registerAddress, uint8_t data) { return write(deviceAddr, registerAddress, 1, &data); } // Return errCode.
	...
	uint8_t writeEP(uint16_t deviceAddr, int pageAddress, uint8_t data) { return writeEP(deviceAddr, pageAddress, 1, &data); } // Return errCode. Writes 32-byte pages. #define I2C_EEPROM_PAGESIZE
