...
namespace I2C_Recovery {
	...
	enum Strategy {S_NoProblem, S_TryAgain, S_Restart, S_WaitForDataLine/*, S_WaitAgain10*/, S_NotFrozen, S_SlowDown, S_SpeedTest, S_PowerDown, S_Disable, S_NoOfStrategies };
