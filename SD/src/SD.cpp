...
boolean SDClass::cardMissing() {
	// fastest way of checking card is missing
	// success takes 4mS, failure takes 14mS
	// compared with re-calling begin() which takes 29mS
	// Must not be called before begin() is called
	return !volume.init(card); 
}
...
boolean SDClass::begin(uint8_t csPin) {
   ...
   */
  root.close(); // SJD MOD to allow repeated begin()
